...
public class Reception extends JFrame{
    ...
    Reception(){
        ...
        panel.setLayout(null);
         panel.setBounds(5,160,1500,650);
        panel.setBackground(new Color(186,245,243));
        add(panel);
        
        JPanel panel1 = new JPanel();
        panel1.setLayout(null);
        panel1.setBounds(5,5,1500,145);
        panel1.setBackground(new Color(186,245,243));
        add(panel1);
        ...
        panel1.add(label);
         ...
         ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource(""));
        Image image1 = i11.getImage().getScaledInstance(300,100,Image.SCALE_DEFAULT);
        ImageIcon i22 = new ImageIcon(image1);
        JLabel label1 = new JLabel(i22);
        label1.setBounds(700,50,300,100);
        panel1.add(label1);
